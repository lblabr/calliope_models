...
aa.to_csv('pv-prognose.csv', index=False, index_label="asdas", header=["Time","PV-Prognose in kWh"])
#PV-Prognose
...
demand.to_csv('demand_node1.csv', index=False, index_label="asdas", header=["Time","Demand"])
#Prognose Demand
